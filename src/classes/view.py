...
class View:
    ...
    def __init__(self, name: str, content: str, filepath: str, base_dir: str):
        ...
        self.view_label: str|None = self.get_view_label()
        self.sql_table_name: str|None = self.get_sql_table_name()
        self.derived_table: str|None = self.get_derived_table()
        self.derived_table_sql: str|None = self.get_derived_table_sql()
    ...
    def get_derived_table(self) -> str|None:
    ...
    def get_derived_table_sql(self) -> str|None:
